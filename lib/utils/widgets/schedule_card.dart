        ...
        child:Column(
          ...
          children: [
            Container(
              ...
              child: Text(widget.eventModel.eventName,textAlign: TextAlign.start,style: AppStyles.b4,),
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  Text(widget.eventModel.team1 ,style: AppStyles.b3,),
                  Text("VS" ,style: TextStyle(fontWeight: FontWeight.w500,fontSize: 8,color: AppColors.white),),
